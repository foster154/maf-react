...
const Template = () => (
  <Wrapper>
    ...
    <p>Before we get too far into this, let’s just pause and remember simply /going/ is something to be celebrated. Just showing up (and doing nothing else) is a victory!</p>
    ...
    <p>I’m not a natural conversation starter, small talker, and mingler. At all. It takes intentional effort to start conversations. It takes even more energy to maintain conversations. And to repeat the process of being engaging in a room full of people I don’t know requires a herculean effort worthy of the annals of time. In situations like this, my gut reaction is to exit stage left, ASAP. If no one knows who you are, it means you can leave and no one will notice, right?</p>

    <p>Everyone will tell you there is immense potential value in the relationships that begin at conferences. I’m not really an expert in that, as I’m new to the whole thing. But in order to even have a /shot/ at it coming true, we need to commit to putting ourselves out there. Not leaving… staying. Engaging. Staying and engaging again. And again.</p>
    ...
    <p>Commit to meeting and having conversations with three new people a day. Get their contact information, shoot them an email or a tweet later in the evening. Step out of your shell and roll the dice on something really valuable happening.</p>
    ...
    <p>I wrote this article with a specific person in mind: someone interested in tech, entrepreneurship, online business, or self-employment, who sees everyone attending conferences, is interested, but hasn’t gone to one yet.</p>
