...
import fastAppCover from '../../assets/projects/covers/fast-app.jpg'
...
export const projectData = [
  {
    ...
    summary: 'The best way for real estate photographers to invoice clients. A React-based web application featuring integration with Stripe and Amazon S3.',
  ...
  },
  {
    ...
    summary: 'A full-featured, internationalization-ready single-page React web application for processing child check-ins for churches, daycares, and other child care organizations. Built using React, Redux, Styled Components, and more.',
    badges: [ 'react', 'redux', 'styled-components', 'html' ]
  },
  {
    name: 'FastApp',
    slug: 'fastapp',
    cover: fastAppCover,
    summary: 'Designs for a prototype mobile app.',
    badges: [ 'sketch' ]
  },
  {
    name: 'Admin Console',
    ...
    summary: 'A mobile application for iOS and Android built with React Native, the Expo framework, and Redux for application state management.',
  ...
  },
  {
    ...
    summary: 'A jQuery web application for setting up and customizing a Raspberry PI-based print server device. Includes custom HTML/CSS theming, integration with a remote API, styling with Sass, and a Gulp-based build process.',
