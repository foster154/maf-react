...
const SupportTracker = () => {
  const project = projectData.find(project => project.name === 'Support Tracker')
  ...
  return (
    <Wrapper>
      ...
      <Content>
        ...
        <p>Support Tracker is a Ruby on Rails web app used to track support cases and follow up tasks.</p>
      ...
      <Screenshots
        data={[
          ...
          {
            image: ss02,
            caption: 'Calendar view, showing case numbers and minutes per day, with weekly totals.'
          },
          {
            image: ss03,
